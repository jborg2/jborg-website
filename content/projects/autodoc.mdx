...
the LLM to summarise methods starting at the highest topological level of the call graph (leaf nodes). Once all called methods for a
 method are summarised, the description of the called methods is injected as comments into the caller method before it is summarised. 
