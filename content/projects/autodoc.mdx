...
AutoDoc works in 2 parts. First static analysis, second is the documentation generation via a Large Language Model. 
...
the LLM to summarise methods starting at the highest toplogical level of the call graph (leaf nodes). Once all called methods for a
 method are summarised, the description of the called methods are injected as comments into the caller method before it is summarised. 
