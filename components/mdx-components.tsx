...
import { HTMLAttributes, ImgHTMLAttributes, TableHTMLAttributes } from "react";
...
const components = {
    ...
    tr: ({ className, ...props }: HTMLAttributes<HTMLElement>) => (
        <tr
            className={cn("m-0 border-t p-0 even:bg-muted", className)}
            {...props}
        />
    ),
    th: ({ className, ...props }: HTMLAttributes<HTMLElement>) => (
        <th
            className={cn(
...
export function Mdx({ code }: MdxProps) {
    // ! couldn't figure out what type this should be
